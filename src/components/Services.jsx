          ...
          <div className="col-md-4 col-sm-6 col-xs-12">
            <div className="services-text">
              ...
              <div className="item-contant">
                ...
                <p>
                  We provide custom web design and development solutions for
                  various industries, including startups, tech products...
                </p>
          ...
          <div className="col-md-4 col-sm-6 col-xs-12">
            <div className="services-text">
              ...
              <div className="item-contant">
                ...
                <p>
                  As a leading software solution development and maintenance
                  service provider company, we strive...
                </p>
                <Link to="/services-contact">
                  Read More <i className="fa fa-arrow-circle-right"></i>
                </Link>
          ...
          <div className="col-md-4 col-sm-6 col-xs-12 mb-3">
            <div className="services-text">
              ...
              <div className="item-contant">
                ...
                <p>
                  Our highly creative Graphic designers help you develop
                  eye-catchy and appealing UI/UX designs based on current...
                </p>
                <Link to="/services-contact">
                  Read More <i className="fa fa-arrow-circle-right"></i>
                </Link>
          ...
          <div className="col-md-4 col-sm-6 col-xs-12 mb-3">
            <div className="services-text">
              ...
              <div className="item-contant">
                ...
                <p>
                  Digital media has a massive impact on our daily lives. Social
                  Media Marketing offers the best option to reach your...
                </p>
                <Link to="/services-contact">
                  Read More <i className="fa fa-arrow-circle-right"></i>
                </Link>
          ...
          <div className="col-md-4 col-sm-6 col-xs-12 mb-3">
            <div className="services-text">
              ...
              <div className="item-contant">
                ...
                <p>
                  As a reliable IT consulting firm, we offer best-in-class IT
                  planning and software consulting services to solve easy to...
                </p>
                <Link to="/services-contact">
                  Read More <i className="fa fa-arrow-circle-right"></i>
                </Link>
