...
const Portfolio = () => {
  ...
  const images = [
    ...
    {
      src: webtemp,
      alt: "Dr. Kshama Kulhalli",
      title: "Dr. Kshama Kulhalli, India",
    },
    {
      src: webtemp,
      alt: "Morya Enterprises",
      title: "Morya Enterprises, India",
    },
    { src: screen18, alt: "Deendari", title: "Deendari, India" },
    {
      src: screen20,
      alt: "Cricstream Predict",
      title: "Cricstream Predict, India",
    },
  ];
                ...
                <div className="container">
                  <div className="row">
                    ...
                    <>
                      ...
                      <div
                        className="gallery_product col-lg-3 col-md-3 col-sm-6 col-xs-12 filter dev"
                        style={{ transition: "8.3s" }}
                      >
                        <a href="">
                          <div className="gallery-img">
                      ...
                      <div
                        className="gallery_product col-lg-3 col-md-3 col-sm-6 col-xs-12 filter dev app"
                        style={{ transition: "1s" }}
                      >
                        <a href="">
                          <div className="gallery-img">
                      ...
                      <div
                        className="gallery_product col-lg-3 col-md-3 col-sm-6 col-xs-12 filter app"
                        style={{ transition: "0.3s" }}
                      >
                        <a href="">
                          <div className="gallery-img">
                          ...
                          <div className="gallery-img">
                            <div className="img-gallery">
                              <img
                                src={webtemp}
                                className="img-responsive"
                                alt="Courier & Logistics Managment"
                              />
                            </div>
                            <div className="galler-text">
