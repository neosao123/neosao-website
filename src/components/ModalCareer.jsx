...
function ModalCareer() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      formData.append("candidateType", values.candType);
      formData.append("years", values.expYear);
      formData.append("month", values.expMonth);
      formData.append("skills", values.skills);
      formData.append("attachment", values.resume);

      await sendCarrierRequestApi(formData)
        .then((res) => {
  ...
  return (
    <>
      <>
        <button className="imported-btn" onClick={handleShow}>
          Apply Now
        </button>
