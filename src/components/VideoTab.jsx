                ...
                <div className="row">
                    ...
                    <div className="col-md-6 col-sm-6 col-xs-12">
                        <div className="video-text-right">
                            <h6>
                                Get Your Site Optimized &amp; <span>Converting Right Now !</span>
                            </h6>
                            <a href="#footer" className="contact_btn animated fadeInUpShort go">
                            ...
                            <a
                                ...
                                data-theVideo={promo}
                            >
                                <i className="fa fa-video-camera" aria-hidden="true"></i> | Watch Video
                            </a>
