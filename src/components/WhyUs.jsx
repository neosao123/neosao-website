        ...
        <div className="row">
          <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12 mb-3">
            <div className="why-text ">
              ...
              <p>
                ...
                customers. We understand how important our customers are to us,
                so we make every effort to assist, guide, and provide the best
                possible solutions, as well as after-sales services and support.
              </p>
            </div>
            {/* why-text */}
          </div>
          ...
          <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12">
            <div className="why-text">
              ...
              <p>
                ...
                high-performance software solutions with tangible results. We
                create a wide variety of web applications, including B2B and B2C
                eCommerce portals, business Commerce solutions, and more.
              </p>
            </div>
            {/* why-text */}
          </div>
          ...
          <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12 ">
            <div className="why-text">
              ...
              <p>
                We offer the best cutting-edge technologies for software
                development solutions and digital marketing services to improve
                your brand value and sales across multiple channels at a very
          ...
          <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12 ">
            <div className="why-text">
              ...
              <p>
                When it comes to managing our customers' tasks, we ensure a
                knowledgeable as well as a dedicated team to complete the tasks.
                Delivering excellence is our company's slogan. We have a
                dedicated team of software professionals who strive for
                excellence.
              </p>
            </div>
            {/* why-text */}
