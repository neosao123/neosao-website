                        ...
                        <nav className="navbar navbar-expand-md navbar-dark new-nav">
                            ...
                            <div className="navbar-collapse collapse" id="navbarCollapse">
                                <ul className="navbar-nav ml-auto">
                                    ...
                                    <li>
                                        <NavLink to='/about-content' className='custom-link'>About </NavLink>
                                    </li>
                                    <li>
                                        <NavLink to='/services-contact' className='custom-link'>Services</NavLink>
                                    </li>
                                    <li>
                                        <NavLink to='/portfolio' className='custom-link'>Portfolio</NavLink>
                                    </li>
                                    <li>
                                        <NavLink to='/career-content' className='custom-link'>Career</NavLink>
                                    </li>
                                </ul>
